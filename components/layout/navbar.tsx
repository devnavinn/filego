          ...
          <NavigationMenu viewport={false}>
            <NavigationMenuList>
              <NavigationMenuItem className="relative">
                ...
                <NavigationMenuContent className="absolute left-1/2 top-full z-50 mt-2 w-[720px] max-w-[calc(100vw-40px)] -translate-x-1/2 rounded-3xl border bg-background p-6 shadow-xl">
